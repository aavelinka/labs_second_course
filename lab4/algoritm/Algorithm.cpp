...
// void Algorithm::drawMenu(const string& title, const string options[], int numOptions) {
...
// void Algorithm::addDeque(Person* person)
// {
...
// void Algorithm::addPerson(int choice)
// {
...
// void Algorithm::actionPerson(int action)
// {
//     if(action == 1)
//     {
