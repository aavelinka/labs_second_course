...
void Employer::saveTextRecord(ostream& os) const
{
...
void Employer::loadFromText(istream& is)
{
    ...
    if (!is)
    {
        throw FileException("Corrupted employer text record");
    }
    setLicense(lic);
    setTaxes(t);
}

void Employer::saveBinaryRecord(ostream& os) const
{
...
void Employer::loadFromBinary(istream& is)
{
    ...
    if (!is)
    {
        throw FileException("Corrupted employer binary record");
    }
